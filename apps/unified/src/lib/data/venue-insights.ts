...
/**
 * Get aggregated insights for a venue
 * This returns only aggregated data - no individual attendee contact info
 */
export async function getVenueInsights(): Promise<VenueInsights> {
  ...
  // Fetch all registrations for venue events
...
function getEmptyInsights(): VenueInsights {
  return {
...
): Promise<VenueInsights["promoter_performance"]> {
