...
export function BookingPageClient({ initialData }: BookingPageClientProps) {
  const router = useRouter();
  const bookingId = initialData.booking.id;
  ...
  const handleRefresh = () => {
    setRefreshing(true);
    // Use router.refresh() to trigger a server-side re-fetch
    router.refresh();
