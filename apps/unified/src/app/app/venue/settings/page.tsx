                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap gap-2 text-xs">
                            ...
                            {template.table_commission_type && (
                              <Badge variant="outline">
                                Table: {template.table_commission_type === "percentage" 
                                  ? `${template.table_commission_rate}%` 
                                  : `${template.table_commission_flat_fee?.toLocaleString()} ${template.currency || "IDR"}`}
                              </Badge>
                            )}
                          </div>
                        </div>
