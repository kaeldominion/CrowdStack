...
/**
 * GET /api/venue/payout-templates/[templateId]
...
export async function GET(
  ...
  try {
    ...
    if (isSuperadmin) {
      ...
      // Regular venues can only access their own templates
...
/**
 * PUT /api/venue/payout-templates/[templateId]
...
export async function PUT(
  ...
  try {
    ...
    if (is_default === true && existingTemplate.venue_id) {
    ...
    if (table_commission_type !== undefined) updateData.table_commission_type = table_commission_type || null;
    if (table_commission_rate !== undefined) updateData.table_commission_rate = table_commission_rate !== null && table_commission_rate !== "" ? parseFloat(table_commission_rate) : null;
    if (table_commission_flat_fee !== undefined) updateData.table_commission_flat_fee = table_commission_flat_fee !== null && table_commission_flat_fee !== "" ? parseFloat(table_commission_flat_fee) : null;
    ...
    // Only filter by venue_id if not superadmin
    if (!isSuperadmin && existingTemplate.venue_id) {
      query = query.eq("venue_id", existingTemplate.venue_id);
    }
...
/**
 * DELETE /api/venue/payout-templates/[templateId]
