  ...
  try {
    ...
    if (error) {
      ...
      if (error.code === "42P01" || error.message?.includes("does not exist")) {
        console.warn("organizer_door_staff table not found - migration may not be applied yet");
        return NextResponse.json({ door_staff: [], organizer_name: "Unknown Organizer" });
      }
