...
export async function GET() {
  try {
    ...
    if (isSuperadmin) {
      ...
      // Regular organizers see only their templates
...
/**
 * POST /api/organizer/payout-templates
...
export async function POST(request: NextRequest) {
  try {
    ...
    const {
      organizer_id, // For superadmins to specify which organizer
      name,
      description,
      currency,
      per_head_rate,
    ...
    if (isSuperadmin && organizer_id) {
      // Superadmin can specify organizer_id
      ...
      // Regular organizers use their own organizer_id
