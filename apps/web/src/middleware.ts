...
export async function middleware(request: NextRequest) {
  ...
  if (isLocalDev && pathname.startsWith("/_next/static/")) {
    ...
    console.log("[Middleware Proxy] 🔍 Static asset request:", {
      pathname,
    ...
    if (isFromAdminApp || chunkPathIncludesAppRoutes) {
      ...
      console.log("[Middleware Proxy] ✅ Proxying static asset to apps/app:", proxyUrl.toString());
      ...
      try {
        ...
        if (proxyResponse.ok) {
          console.log("[Middleware Proxy] ✅ Successfully proxied static asset from apps/app");
          ...
          console.log("[Middleware Proxy] ⚠️ Static asset not found in apps/app (status:", proxyResponse.status, "), falling back to web app");
        }
      } catch (error) {
        console.error("[Middleware Proxy] ❌ Error proxying static chunk from apps/app:", error);
      ...
      console.log("[Middleware Proxy] ⏭️ Not proxying - doesn't match admin/app/door pattern");
    }
  }
