...
async function getEvent(slug: string) {
  try {
    const baseUrl = process.env.NEXT_PUBLIC_WEB_URL || "http://localhost:3006";
...
export default async function EventPage({
  ...
  const shareUrl = `${process.env.NEXT_PUBLIC_WEB_URL || "http://localhost:3006"}/e/${params.eventSlug}`;
